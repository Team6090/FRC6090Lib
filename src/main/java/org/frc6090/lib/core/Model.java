...
/**
 * Model implements the ModelBase robot program framework.
 *
 * <p>The Model class is intended to be subclassed by a user creating a robot program.
 *
 * <p>periodic() functions from the base class are called on an interval by a Notifier instance.
 */
public class Model extends IterativeModelBase {
   ...
   */
  protected Model(double period) {
    super(period);
    m_startTime = Timer.getFPGATimestamp();
    addPeriodic(this::loopFunc, period);
    NotifierJNI.setNotifierName(m_notifier, "Model");
