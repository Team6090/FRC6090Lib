...
import org.frc6090.lib.datasystem.DataSystemBase;
 ...
 * </ul>
 */
public abstract class IterativeModelBase extends ModelBase {
  private enum Mode {
    kNone,
    kDisabled,
    kAutonomous,
   ...
   */
  protected IterativeModelBase(double period) {
    m_period = period;
  ...
  protected void loopFunc() {
    ...
    DataSystemBase.runUpdates();
    m_watchdog.addEpoch("DataSystemBase.runUpdates()");
